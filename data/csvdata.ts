...
export const simple = `${hp}\n${mp}\n${qe}\n`

export const withnull = `${nl}\n${hp}\n${mp}\n${nl}\n${qe}\n${nl}\n`

export const withheader = `${header}\n${hp}\n${mp}\n${qe}\n`

export const simpleskip3 = `line 1 to skip \nline 2 to skip \nline 3 to skip\n${hp}\n${mp}\n${qe}\n`

export const withheaderskip3 = `line 1 to skip \nline 2 to skip \nline 3 to skip\n${header}\n${hp}\n${mp}\n${qe}\n`

export const withcomment = `# comment no 1 - \n${hp}\n# comment no 2 -- \n${mp}\n# comment no 3 --- \n# comment no 4 ----\n${qe}\n# comment no 5 -----\n`
