...
class ShapefileParser extends geofile_1.GeofileParser {
    ...
    begin() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.dbffile)
                this.dbfheader = yield ShapefileParser.dbfHeaderReader(this.dbffile);
            this.state = 'header';
            this.recsize = 0;
            this.recpos = 0;
    ...
    */
    static dbfHeaderReader(dbffile) {
        return __awaiter(this, void 0, void 0, function* () {
            // read header
            const hdv = yield dbffile.dataview(0, 32);
            ...
            const fdv = yield dbffile.dataview(32, fldsize);
